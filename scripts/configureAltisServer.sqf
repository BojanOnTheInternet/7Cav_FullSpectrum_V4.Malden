...
SERVER_Weather =
[
	[[0.30, 0.50, 0.75], 12/31, 0.0], // January
	[[0.30, 0.50, 0.75], 12/28, 0.1],
	[[0.20, 0.40, 0.75], 9/31, 0.1],
	[[0.20, 0.20, 0.65], 6/30, 0.1],
	[[0.20, 0.20, 0.65], 3/31, 0.2],
	[[0.00, 0.20, 0.55], 1/30, 0.2], // June
	[[0.00, 0.10, 0.55], 0/31, 0.2],
	[[0.00, 0.10, 0.35], 1/31, 0.2],
	[[0.10, 0.20, 0.55], 5/30, 0.5],
	[[0.20, 0.40, 0.65], 9/31, 0.8],
	[[0.30, 0.50, 0.75], 13/30, 0.5],
	[[0.40, 0.60, 0.75], 16/31, 0.2]  // December
];
